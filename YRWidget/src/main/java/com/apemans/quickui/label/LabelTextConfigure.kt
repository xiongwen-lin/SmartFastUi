...
object GlobalLabelTextConfigure {
    ...
    var subTextColor: Int = -1
        get() {
            if (field == -1) {
                throw RuntimeException("Please config subTextColor,you can apply by R.color.theme_sub_text_color")
            }
            return field
        }
    var detailTextColor: Int = -1
        get() {
            if (field == -1) {
                throw RuntimeException("Please config detailTextColor,you can apply by R.color.theme_sub_text_color")
            }
            return field
        }
    var selectionOnColor: Int = -1
        get() {
            if (field == -1) {
                throw RuntimeException("Please config selectionOnColor,you can apply by R.color.theme_color ")
            }
            return field
        }
...
data class LabelTextConfigure(var text: String = "") {
    ...
    var leftIconRes: Int = 0
    var leftIconVisibility: Int = View.GONE
    var rightIconRes: Int = R.drawable.tools_right_arrow_gray
