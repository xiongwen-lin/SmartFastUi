...
abstract class BaseActionSuperDialog : GenjiDialog() {
    ...
    private var editBoxRightTxt: String? = null
    ...
    private fun findDialogBasicView(viewHolder: ViewHolder) {
        ...
        centerImageView = viewHolder.getView(R.id.imv_center)
        ...
        txt_remind = viewHolder.getView(R.id.txt_reminds)
        smartEditBox = viewHolder.getView(R.id.smartEditBox)
        Log.e("showRemind","txt_remind =null,${txt_remind ==null}")
    }
    ...
    open fun initView(viewHolder: ViewHolder) {
        ...
        centerImageRes?.let {
            centerImageView?.setImageResource(it)
    ...
    private var showRemindTxt: String? = null
    ...
    fun setCenterImage(@DrawableRes centerImage: Int): BaseActionSuperDialog {
        this.centerImageRes = centerImage
        return this
    }
    ...
    fun showEditBox(show: Boolean, showKeyboard: Boolean = true, hint: String? = null,rightTxt: String? = null, defaultText: String? = null): BaseActionSuperDialog {
     ...
     * 支持复选框提示
     */
    fun showRemind(showRemind: Boolean,checkBoxString: String): BaseActionSuperDialog {
        this.showRemind = showRemind
        showRemindTxt = checkBoxString
        Log.e("showRemind","txt_remind =null,${txt_remind ==null}"+" txt_remind?.text ="+ txt_remind?.text +",checkBoxString="+checkBoxString)
        return this
    }
